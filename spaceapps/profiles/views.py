...
def create_profile(request, form_class=None, success_url=None,
    ...
    **Template:**
    ...
    try:
        ...
        return HttpResponseRedirect(reverse('profiles:profiles_edit_profile'))
    ...
    if success_url is None:
        success_url = reverse('profiles:profiles_profile_detail',
...
def edit_profile(request, form_class=ProfileForm, success_url=None,
    ...
    **Template:**
    ...
    try:
        ...
        return HttpResponseRedirect(reverse('profiles:profiles_create_profile'))
